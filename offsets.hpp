...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-1a951716f19e4638";
    ...
    namespace Animator {
         inline constexpr uintptr_t ActiveAnimations = 0x9e8;
    }
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x7da8a78;
    }
